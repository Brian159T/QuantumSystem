...
import { estacionesUseCase } from '../../../data'
import type { EstacionCarga, VelocidadCarga } from '../../../domain/modelos/EstacionesYTalleres'
...
export default function PaginaEstaciones() {
  const [estaciones, setEstaciones] = useState<EstacionCarga[]>([])
  const [busqueda, setBusqueda] = useState('')
  const [filtro, setFiltro] = useState<FiltroConector>('Todos')
  const [soloDisponibles, setSoloDisponibles] = useState(false)

  useEffect(() => {
    estacionesUseCase.obtenerEstaciones().then(setEstaciones)
  }, [])
