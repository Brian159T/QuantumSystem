...
import { talleresUseCase } from '../../../data'
import type { ServicioTecnico } from '../../../domain/modelos/EstacionesYTalleres'
...
export default function PaginaTalleres() {
  const [talleres, setTalleres] = useState<ServicioTecnico[]>([])
  const [busqueda, setBusqueda] = useState('')
  const [especialidad, setEspecialidad] = useState('Todos')
  const [soloAbiertos, setSoloAbiertos] = useState(false)

  useEffect(() => {
    talleresUseCase.obtenerTalleres().then(setTalleres)
  }, [])
