...
async function agregar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        respuesta.success(req, res, 'Color agregado satisfactoriamente', 201);
    } catch (error) {
        next(error);
    }
}
...
async function actualizar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        respuesta.success(req, res, 'Color actualizado satisfactoriamente', 200);
    } catch (error) {
        next(error);
    }
}
...
async function eliminar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        respuesta.success(req, res, 'Color eliminado satisfactoriamente', 200);
    } catch (error) {
        next(error);
    }
}
