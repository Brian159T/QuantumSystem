...
async function uno(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
...
async function agregar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        respuesta.success(req, res, 'Reserva agregada satisfactoriamente', 201);
    } catch (error) {
        next(error);
    }
}
...
async function actualizar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        const id = Number(req.params.id);
        const body = req.body;
        await controlador.actualizar(id, body);
        respuesta.success(req, res, 'Reserva actualizada satisfactoriamente', 200);
    } catch (error) {
        next(error);
    }
}
...
async function eliminar(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        respuesta.success(req, res, 'Reserva eliminada satisfactoriamente', 200);
    } catch (error) {
        next(error);
    }
}
